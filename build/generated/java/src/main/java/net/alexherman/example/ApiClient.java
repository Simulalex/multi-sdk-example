...
import net.alexherman.example.auth.Authentication;
import net.alexherman.example.auth.HttpBasicAuth;
import net.alexherman.example.auth.HttpBearerAuth;
import net.alexherman.example.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  protected String basePath = "https://ron-swanson-quotes.herokuapp.com/v2";
